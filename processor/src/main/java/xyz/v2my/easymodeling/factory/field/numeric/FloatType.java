...
public class FloatType extends NumericType<Float> {

    private FloatType(TypeName type, FieldWrapper field) {
        super(type, field);
    }
    ...
    @Override
    public PlainType<Float> create(TypeName type, FieldWrapper field) {
        return new FloatType(type, field);
    }
}
