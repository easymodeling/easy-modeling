...
public class GenerationPatterns {
    ...
    public static String BUILDER_CLASS_JAVADOC(ClassName className) {
        return "" +
    ...
    public static String STATIC_BUILDER_METHOD_JAVADOC(ClassName className) {
        return "" +
    ...
    public static String STATIC_LIST_METHOD_JAVADOC(ClassName className) {
        return "" +
    ...
    public static String STATIC_SIZED_LIST_METHOD_JAVADOC(ClassName className) {
        return "" +
                "Returns a {@code List} of randomly populated instance of \n" +
    ...
    public static String STATIC_NEXT_METHOD_JAVADOC(ClassName className) {
        return "" +
    ...
    public static String STATIC_STREAM_METHOD_JAVADOC(ClassName className) {
        return "" +
    ...
    public static String MODELER_JAVADOC() {
        return "Generated by EasyModeling at " + ZonedDateTime.now() + "\n";
    }
