...
class ByteFieldTest {
    ...
    @Nested
    class RangedByteFieldTest extends ModelFieldTest {
        ...
        protected void setUp() {
            ...
            modelField = new ByteField().create(fieldCustomization);
        }
        ...
        protected void should_generate_initializer() {
            ...
            assertThat(initializer).hasToString("new " + $(ByteRandomizer.class) + "(-2.0, 9.0)");
        }
    }

    @Nested
    class ConstantByteFieldTest extends ModelFieldTest {
        ...
        protected void should_generate_initializer() {
            ...
            assertThat(initializer).hasToString("new " + $(ByteRandomizer.class) + "((byte) 12)");
        }
    }

    @Nested
    class UnboxedByteFieldTest extends ModelFieldTest {
        ...
        protected void should_generate_initializer() {
            ...
            assertThat(initializer).hasToString("new " + $(ByteRandomizer.class) + "(0.0, 2.0)");
        }
