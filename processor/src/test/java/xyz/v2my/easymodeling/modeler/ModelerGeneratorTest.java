    ...
    class MemberTypeMethodTest {
        ...
        void setUp() {
            ...
            typeMethod = type.methodSpecs.stream()
                    .filter(methodSpec -> methodSpec.name.equals(TYPE_METHOD_NAME))
        ...
        void should_be_protected_and_named_as_type() {
            ...
            assertThat(typeMethod.name).isEqualTo(TYPE_METHOD_NAME);
    ...
    class MemberPopulateMethodTest {
        ...
        void setUp() {
            ...
            populateMethod = type.methodSpecs.stream()
                    .filter(methodSpec -> methodSpec.name.equals(MEMBER_POPULATE_METHOD_NAME))
        ...
        void should_be_protected_and_named_as_populate() {
            ...
            assertThat(populateMethod.name).isEqualTo(MEMBER_POPULATE_METHOD_NAME);
        }
