...
class DoubleFieldTest {
    ...
    class RangedDoubleFieldTest extends FieldTest {
        ...
        protected void setUp() {
            ...
            modelField = new DoubleField().create(fieldWrapper);
        }
        ...
        protected void should_generate_initializer() {
            ...
            assertThat(initializer.toString()).isEqualTo("new " + $(DoubleRandomizer.class) + "(-2.0, 9.0)");
        }
    }
    ...
    class ConstantDoubleFieldTest extends FieldTest {
        ...
        protected void should_generate_initializer() {
            ...
            assertThat(initializer.toString()).isEqualTo("new " + $(DoubleRandomizer.class) + "(12.0)");
        }
    }
    ...
    class UnboxedDoubleFieldTest extends FieldTest {
        ...
        protected void should_generate_initializer() {
            ...
            assertThat(initializer.toString()).isEqualTo("new " + $(DoubleRandomizer.class) + "(0.0, 2.0)");
        }
